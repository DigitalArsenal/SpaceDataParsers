...
exports.OMMT = exports.OMM = void 0;
const tslib_1 = require("tslib");
const flatbuffers = tslib_1.__importStar(require("flatbuffers"));
const ephemerisType_1 = require("./ephemerisType");
const manCovRefFrame_1 = require("./manCovRefFrame");
const meanElementTheory_1 = require("./meanElementTheory");
...
class OMM {
    ...
    REF_FRAME() {
        ...
        return offset ? this.bb.readInt8(this.bb_pos + offset) : referenceFrame_1.referenceFrame.TEME;
    }
    ...
    TIME_SYSTEM() {
        ...
        return offset ? this.bb.readInt8(this.bb_pos + offset) : timeSystem_1.timeSystem.UTC;
    }
    MEAN_ELEMENT_THEORY() {
        const offset = this.bb.__offset(this.bb_pos, 22);
        return offset ? this.bb.readInt8(this.bb_pos + offset) : meanElementTheory_1.meanElementTheory.SGP4;
    }
    ...
    EPHEMERIS_TYPE() {
        ...
        return offset ? this.bb.readInt8(this.bb_pos + offset) : ephemerisType_1.ephemerisType.SGP4;
    }
    ...
    COV_REF_FRAME() {
        ...
        return offset ? this.bb.readInt8(this.bb_pos + offset) : manCovRefFrame_1.manCovRefFrame.RSW;
    }
    CX_X() {
    ...
    static addREF_FRAME(builder, REF_FRAME) {
        builder.addFieldInt8(6, REF_FRAME, referenceFrame_1.referenceFrame.TEME);
    }
    ...
    static addTIME_SYSTEM(builder, TIME_SYSTEM) {
        builder.addFieldInt8(8, TIME_SYSTEM, timeSystem_1.timeSystem.UTC);
    }
    static addMEAN_ELEMENT_THEORY(builder, MEAN_ELEMENT_THEORY) {
        builder.addFieldInt8(9, MEAN_ELEMENT_THEORY, meanElementTheory_1.meanElementTheory.SGP4);
    }
    ...
    static addEPHEMERIS_TYPE(builder, EPHEMERIS_TYPE) {
        builder.addFieldInt8(25, EPHEMERIS_TYPE, ephemerisType_1.ephemerisType.SGP4);
    }
    ...
    static addCOV_REF_FRAME(builder, COV_REF_FRAME) {
        builder.addFieldInt8(33, COV_REF_FRAME, manCovRefFrame_1.manCovRefFrame.RSW);
    }
...
class OMMT {
    ...
    USER_DEFINED_EPOCH_TIMESTAMP;
    USER_DEFINED_MICROSECONDS;
    constructor(CCSDS_OMM_VERS = 0.0, CREATION_DATE = null, ORIGINATOR = null, OBJECT_NAME = null, OBJECT_ID = null, CENTER_NAME = null, REF_FRAME = referenceFrame_1.referenceFrame.TEME, REF_FRAME_EPOCH = null, TIME_SYSTEM = timeSystem_1.timeSystem.UTC, MEAN_ELEMENT_THEORY = meanElementTheory_1.meanElementTheory.SGP4, COMMENT = null, EPOCH = null, SEMI_MAJOR_AXIS = 0.0, MEAN_MOTION = 0.0, ECCENTRICITY = 0.0, INCLINATION = 0.0, RA_OF_ASC_NODE = 0.0, ARG_OF_PERICENTER = 0.0, MEAN_ANOMALY = 0.0, GM = 0.0, MASS = 0.0, SOLAR_RAD_AREA = 0.0, SOLAR_RAD_COEFF = 0.0, DRAG_AREA = 0.0, DRAG_COEFF = 0.0, EPHEMERIS_TYPE = ephemerisType_1.ephemerisType.SGP4, CLASSIFICATION_TYPE = null, NORAD_CAT_ID = 0, ELEMENT_SET_NO = 0, REV_AT_EPOCH = 0.0, BSTAR = 0.0, MEAN_MOTION_DOT = 0.0, MEAN_MOTION_DDOT = 0.0, COV_REF_FRAME = manCovRefFrame_1.manCovRefFrame.RSW, CX_X = 0.0, CY_X = 0.0, CY_Y = 0.0, CZ_X = 0.0, CZ_Y = 0.0, CZ_Z = 0.0, CX_DOT_X = 0.0, CX_DOT_Y = 0.0, CX_DOT_Z = 0.0, CX_DOT_X_DOT = 0.0, CY_DOT_X = 0.0, CY_DOT_Y = 0.0, CY_DOT_Z = 0.0, CY_DOT_X_DOT = 0.0, CY_DOT_Y_DOT = 0.0, CZ_DOT_X = 0.0, CZ_DOT_Y = 0.0, CZ_DOT_Z = 0.0, CZ_DOT_X_DOT = 0.0, CZ_DOT_Y_DOT = 0.0, CZ_DOT_Z_DOT = 0.0, USER_DEFINED_BIP_0044_TYPE = 0, USER_DEFINED_OBJECT_DESIGNATOR = null, USER_DEFINED_EARTH_MODEL = null, USER_DEFINED_EPOCH_TIMESTAMP = 0.0, USER_DEFINED_MICROSECONDS = 0.0) {
