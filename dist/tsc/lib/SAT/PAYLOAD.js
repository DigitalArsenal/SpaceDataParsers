...
const massType_1 = require("./massType");
class PAYLOAD {
    bb = null;
    bb_pos = 0;
    __init(i, bb) {
    ...
    MASS_TYPE() {
        ...
        return offset ? this.bb.readInt8(this.bb_pos + offset) : massType_1.massType.DRY;
    }
...
class PAYLOADT {
    ...
    MASS;
    MASS_TYPE;
    constructor(OBJECT_ID = null, OBJECT_NAME = null, DEPLOYMENT_DATE = null, MANEUVERABLE = false, SIZE = 0.0, MASS = 0.0, MASS_TYPE = massType_1.massType.DRY) {
