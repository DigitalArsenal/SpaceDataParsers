...
//	dtmindextype dtmindex;  // needed because numbers weren't passing correctly
  ...
  // --------------------------------------------------
#ifdef _MSC_VER
	strcpy(infilename, sizeof(infilename), PATH_TO_DEN_UNC_1);
...
#ifdef _MSC_VER
	strcpy(infilename, sizeof(infilename), PATH_TO_DEN_UNC_2);
...
#ifdef _MSC_VER
	strcpy(infilename, sizeof(infilename), PATH_TO_DEN_UNC_3);
...
#ifdef _MSC_VER
	strcpy(titre, sizeof(titre), longstr1);
#else
...
#ifdef _MSC_VER
	strcpy(Com, sizeof(Com), longstr1);
#else
	strcpy(Com, longstr1);
#endif
	//      scanf( "%s",&Com );
